<template>
  <el-dialog
    ...
    :visible="insCityDialogVisible"
    width="30%"
    :before-close="handleClose"
    @close="citysDialogClosed"
    append-to-body
  >
    <el-form ref="form" :rules="rules" :model="citys" label-width="95px">
      ...
      <el-form-item label="启用:">
        <el-switch v-model="citys.status"> </el-switch>
      </el-form-item>
    </el-form>
    <span slot="footer" class="dialog-footer">
      <el-button size="medium" type="info" @click="handleClose"
        >取 消</el-button
      >
      <el-button size="medium" type="success" @click="saveCity"
        >确 定</el-button
      >
    </span>
  </el-dialog>
...
import { citySaveOrUpd } from '@/api/config/region'
export default {
  name: 'InsCityDialog',
  data() {
    return {
  ...
  methods: {
    ...
    saveCity() {
      this.$refs['form'].validate(async (valid) => {
        ...
        const res = await citySaveOrUpd(this.citySaveOrUpdate, this.citys)
